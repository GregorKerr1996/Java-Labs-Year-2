...
public class BrickSet implements Comparable<BrickSet> {
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof BrickSet) {
			...
			return Objects.equals(this.setNumber, other.setNumber) && Objects.equals(this.name, other.name)
					&& Objects.equals(this.theme, other.theme) && Objects.equals(this.retailPrice, other.retailPrice)
	...
	public String toString() {
		...
		return this.setNumber + "," + this.name + "," + this.theme + "," + this.numPieces + "," + this.retailPrice;
	}

	@Override
	public int compareTo(BrickSet o) {
		// TODO Auto-generated method stub
		// comapring set numbers

		return this.setNumber - o.getSetNumber();
